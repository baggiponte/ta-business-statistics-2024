...
1. Sequence types: vectors, matrices and dataframes.
...
4. **Exercise:** Generate a sample of 200 observations from a Poisson distribution with lambda = 5. Compute the sample skewness and sample kurtosis.
